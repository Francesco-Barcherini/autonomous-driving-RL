...
The final model uses five lidar rays distributed from $-\alpha$ to $+\alpha$, where $\alpha$ is configured to be 45 degrees. Earlier experiments also used a three-lidar version with only left, center and right rays.
